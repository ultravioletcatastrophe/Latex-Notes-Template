...
\end{theorem}
\marginnote{Here is a margin note: I use these generally to annotate my own thoughts or questions during lecture. If used for producing some kind of document with external consumption in mind, margin notes are good for imparting intuition and introducing individual, idiosyncratic, and informal, but, illuminating and illustrative ideologies.
